...
#if IS_ENABLED(CONFIG_HEARTBREAK_BONGO_CAT)
#include "heartbreak_bongo_cat_widget.h"

static struct heartbreak_bongo_cat_widget bongo_widget;
...
#if IS_ENABLED(CONFIG_HEARTBREAK_BONGO_CAT)
    heartbreak_bongo_cat_widget_init(&bongo_widget, center_frame);
#else
...
#endif // IS_ENABLED(CONFIG_HEARTBREAK_BONGO_CAT)
